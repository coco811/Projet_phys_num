...
class euler:
    ...
    def calcul_position(self):
        for corps_obs in self.corps:
            corps_obs.position.x += corps_obs.vitesse.x * self.pas_temps / 2
            corps_obs.position.y += corps_obs.vitesse.y * self.pas_temps / 2
            corps_obs.position.z += corps_obs.vitesse.z * self.pas_temps / 2
